...
import aboutPhoto from '@/assets/img/photo.svg';
import imageIcon from '@/assets/img/image 7.svg';
        ...
        <>
            <section className="container-about" id="about-me">
                <div className="container-photo" data-aos="fade-right">
                    <img src={aboutPhoto} alt="Victor André Lopes Brasileiro" />
                </div>
                <div className="container-text" data-aos="fade-left">
                    <h2>About Me <span><img src={imageIcon} alt="About Me Icon" /></span></h2>
                    <p>
